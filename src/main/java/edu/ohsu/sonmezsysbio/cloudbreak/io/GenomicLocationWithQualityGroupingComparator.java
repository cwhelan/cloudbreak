 ...
 * Time: 1:22 PM
 */
public class GenomicLocationWithQualityGroupingComparator implements RawComparator<GenomicLocationWithQuality> {

    private final GenomicLocationWithQuality key1;
    private final GenomicLocationWithQuality key2;
    private final DataInputBuffer buffer;

    public GenomicLocationWithQualityGroupingComparator() {
