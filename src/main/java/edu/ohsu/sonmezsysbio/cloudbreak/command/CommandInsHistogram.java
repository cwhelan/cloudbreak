...
public class CommandInsHistogram extends BaseCloudbreakCommand {
    ...
    private void runHadoopJob(Configuration configuration) throws IOException, URISyntaxException {
        ...
        conf.setJobName("Compute Insert Histograms");
	...
	// conf.setReducerClass(ReadPairInfoToInsHistogram.class);
